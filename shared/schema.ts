...
export const PLAN_LIMITS = {
  ...
  pro: {
    ...
    agents: 10,
    funnels: 10,
    features: ["Full CRM & Pipeline", "10 AI Agents", "500 Leads/month", "1,000 AI Chats/month", "500 SMS/month", "5,000 Emails/month", "50 Voice AI Calls", "10 Sales Funnels", "Marketing Automation", "B2B Intelligence", "Priority Support"],
  },
  enterprise: {
    name: "Enterprise",
    price: 499.99,
    ...
    agents: -1,
    funnels: -1,
    features: ["Unlimited AI Agents", "Unlimited Leads", "Unlimited AI Chats", "2,000 SMS/month", "Unlimited Emails", "Unlimited Voice AI", "Unlimited Funnels", "Custom Workflows", "AI Outreach Agent", "Bring Your Own API Keys", "Dedicated Account Manager", "White-Glove Onboarding"],
  },
} as const;
