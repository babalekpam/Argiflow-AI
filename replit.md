...
- **AI Agent Console**: Run 6 built-in agents (Lead Scout, Cold Email Writer, Reply Analyzer, Intent Monitor, Meeting Booker, Forum Prospector) with any configured LLM provider. API: `/api/agent-console/*`. DB: `agent_runs` table.
