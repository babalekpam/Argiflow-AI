  ...
  western: {
    ...
    plans: {
      starter: {
        ...
        agentLimit: 1,
        leadsPerMonth: 5,
        features: ["10 AI chats/month", "20 emails/month", "5 leads/month", "CRM & lead management", "AI marketing strategy", "Community support", "Full platform access"],
      },
      pro: {
        name: "Pro",
        price: { USD: 259.99, EUR: 239.99, GBP: 209.99 },
        interval: "month",
        agentLimit: 5,
        leadsPerMonth: 500,
        features: ["1,000 AI chats/month", "500 SMS/month", "5,000 emails/month", "50 Voice AI calls/month", "500 leads/month", "10 Sales funnels & engagement tracking", "B2B Sales Intelligence", "Priority support"],
      },
      enterprise: {
        name: "Enterprise",
        price: { USD: 499.99, EUR: 459.99, GBP: 399.99 },
        interval: "month",
        agentLimit: -1,
        leadsPerMonth: -1,
