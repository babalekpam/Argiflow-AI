...
function normalizeCompany(c: any): any {
  return {
    ...
    industry: c.industry || "",
    subIndustry: c.subIndustry || c.sub_industry || "",
    description: c.description || "",
    location: c.location || [c.city || c.hq_city || c.hqCity, c.state || c.hq_state || c.hqState, c.country || c.hq_country || c.hqCountry].filter(Boolean).join(", ") || "",
    employeeCount: c.employeeCount || c.employee_count || c.employeeRange || c.employee_range || "",
    employeeRange: c.employeeRange || c.employee_range || c.employeeCount || c.employee_count || "",
    phone: c.phone || c.main_phone || c.mainPhone || "",
    email: c.email || c.main_email || c.mainEmail || "",
    revenue: c.revenue || c.annualRevenue || c.annual_revenue || "",
